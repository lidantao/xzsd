package com.xzsd.app.customer.shopCar.service;

import com.neusoft.security.client.utils.SecurityUtils;
import com.neusoft.util.StringUtil;
import com.xzsd.app.customer.shopCar.dao.ShopCarDao;
import com.xzsd.app.customer.shopCar.entity.ShopCarDTO;
import com.xzsd.app.customer.shopCar.entity.ShopCarInfo;
...
public class ShopCarService {
    ...
    public Response addShopCar(ShopCarInfo shopCarInfo){
        //检查库存是否满足购买数量
        String stock = shopCarDao.findGoodsStock(shopCarInfo);
